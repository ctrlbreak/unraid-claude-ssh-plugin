...
echo ""
echo "  Next steps:"
echo "    1. Add your SSH public key to flash so it survives reboots:"
echo "         echo 'ssh-ed25519 AAAA... comment' >> /boot/config/plugins/claude-ssh/authorized_keys"
echo "       then reinstall the plugin (or reboot) to apply it. The command="
echo "       filter restriction is added automatically on every boot."
